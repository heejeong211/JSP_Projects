						...
						<div class="col-sm-6">
							<div class="contactinfo">
								<ul class="nav nav-pills">
									<li><a href="#"><i class="fa fa-phone"></i> +2 95 01
											88 821</a></li>
				...
				<div class="row">
					...
					<div class="col-sm-9 padding-right">
						<div class="features_items">
							...
							<c:set var="ran"><%= java.lang.Math.round(java.lang.Math.random() * 5 +1) %></c:set>
								<div class="col-sm-4">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="images/home/product${ran}.jpg" alt="" />
												<h2>￦${dto.sal}</h2>
												<!-- <fmt:setLocale value="ko-KR"/> 원화 -->
												<p>${dto.ename}</p>
